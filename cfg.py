...
# Cfg.cfgfile = os.path.join(_BASE_DIR, 'cfg', 'yolov3-custom.cfg')
...
Cfg.learning_rate = 0.000000000261
Cfg.burn_in = 1000
...
# Cfg.train_label = os.path.join(_BASE_DIR, 'data', 'train_simple.txt')
# Cfg.val_label = os.path.join(_BASE_DIR, 'data', 'test_simple.txt')
